public class Gloves extends Item{
    private String itemType= "Gloves";
    private String name;
    private int value;
    ...
    public Gloves(String pName, int pValue, String pRarity, int pArmor, int pMagicalEffect, String pMagicalType, String pRareType, int pRareEffect){
        itemType = "Gloves";
        this.name = pName;
        this.value = pValue;
        this.rarity = pRarity;
