public class Helmet extends Item{
    private String itemType= "Helmet";
    private String name;
    private int value;
    ...
    public Helmet(String pName, int pValue, String pRarity, int pArmor, int pMagicalEffect, String pMagicalType, String pRareType, int pRareEffect){
        itemType = "Helmet";
        this.name = pName;
        this.value = pValue;
        this.rarity = pRarity;
