public class Shield extends Item{
    private String itemType= "Shield";
    private String name;
    private int value;
    ...
    public Shield(String pName, int pValue, String pRarity, int pArmor, int pMagicalEffect, String pMagicalType, String pRareType, int pRareEffect){
        itemType = "Shield";
        this.name = pName;
        this.value = pValue;
        this.rarity = pRarity;
